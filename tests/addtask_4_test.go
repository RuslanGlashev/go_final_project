...
func TestAddTask(t *testing.T) {
	...
	tbl = []task{
		...
		{"20240108", "Уроки", "", "d 10"},
		{"20240102", "Отдых в Сочи", "На лыжах", "y"}, //<== не понимаю почему этот тест не проходит
		{"today", "Фитнес", "", "d 1"},
		{"today", "Шмитнес", "", ""},
	}
	check()
...
//--- FAIL: TestAddTask (0.07s)
//    addtask_4_test.go:147: Дата не может быть меньше сегодняшней {20240102 Отдых в Сочи На лыжах y}
//FAIL
//FAIL    github.com/RuslanGlashev/go_final_project/tests 0.141s
//FAIL

//Другой вариант:

//--- FAIL: TestAddTask (0.05s)
//    addtask_4_test.go:127: Неожиданная ошибка Дата не может быть меньше сегодняшней для задачи {20240102 Отдых в Сочи На лыжах y}
//FAIL
//FAIL    github.com/RuslanGlashev/go_final_project/tests 0.111s
//FAIL
